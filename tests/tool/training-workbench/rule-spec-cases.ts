...
export const TRAINING_RENEWAL_CASES: RenewalRuleCase[] = [
  ...
  { project: "TSA", scenario: "首次培训", oldExpiry: null, trainingDate: "2026-05-06", expectedJudgement: "首次/无旧值", expectedNewExpiry: "2027-05-31" },
  { project: "TSA", scenario: "有效期内复训", oldExpiry: "2026-05-31", trainingDate: "2026-05-06", expectedJudgement: "无窗口", expectedNewExpiry: "2027-05-31" },
...
export const TRAINING_SCHEDULE_CASES: ScheduleRuleCase[] = [
  ...
  { project: "TSA", scenario: "无窗口项目在本阶段到期", oldExpiry: "2026-05-31", stageStart: "2026-05-01", stageEnd: "2026-05-31", expectedStatus: "本阶段到期" }
];
