...
const tools: ToolItem[] = [
    ...
    { name: '通用锁班助手', desc: 'Python脚本，一键批量录入锁班信息', entry: 'lock-entry-helper', status: 'done' },
    { name: '飞行经历/左座经历起落数按天统计', desc: 'Python脚本，一键批量飞行经历/左座经历起落数', entry: 'flight-stats-helper', status: 'done' },
    { name: '酒店账单核对', desc: '一键对比酒店账单与入住登记表', entry: 'hotel-bill-check', status: 'done' },
    ...
    { name: '人员结构统计', desc: '导入人员信息表，按报告口径一键生成人员结构', entry: 'personnel-structure-stats', status: 'wip' }
];
