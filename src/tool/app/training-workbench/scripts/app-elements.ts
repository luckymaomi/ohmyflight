(function () {
  ...
  runtime.elements = {
    ...
    annualTrainingProjectSelect: requireElement("annualTrainingProjectSelect", HTMLSelectElement),
    annualTrainingYearSelect: requireElement("annualTrainingYearSelect", HTMLSelectElement),
    annualTrainingMonthSelect: requireElement("annualTrainingMonthSelect", HTMLSelectElement),
    annualTrainingSummary: requireElement("annualTrainingSummary", HTMLElement),
    annualTrainingDateChart: requireElement("annualTrainingDateChart", HTMLElement),
