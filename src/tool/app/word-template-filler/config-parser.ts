...
const ConfigParser = {
    ...
    // 解析单行字段配置
    parseFieldRow: (row: WordTemplateConfigRow): WordTemplateFieldConfig | null => {
        // 支持中英文列名
        ...
        return {
            ...
            rows: Number.parseInt(String(rows), 10) || 3
        };
    },
    ...
    normalizeType: (type: unknown): string => {
        ...
        return typeMap[rawType] || typeMap[normalized] || normalized || 'text';
    }
};
