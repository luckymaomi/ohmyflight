(function () {
  ...
  function buildUpdatedPeopleSheet(peopleInfo, updatedRowMap) {
    ...
    const reportSheet = {};
    const updatedItems = Array.from(updatedRowMap.values()) as SuperTrainingUpdatedRowEntry[];
  ...
  function writeSummaryArea(reportSheet, peopleInfo, updateResult, selectedProjectNames, selectedMonthKeys) {
    ...
    const updatedItems = Array.from(updateResult.updatedRowMap.values()) as SuperTrainingUpdatedRowEntry[];
  ...
  window.SuperTraining.ReportSheet = {
