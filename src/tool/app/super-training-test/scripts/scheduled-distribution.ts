(function () {
  ...
  function getTrainingDate(row: SuperTrainingSheetRow, sheetInfo: any) {
  ...
  function buildRows(analysis: SuperTrainingAnalysis | null): ScheduledDistributionRow[] {
  ...
  function buildDistribution(analysis: SuperTrainingAnalysis | null, filters: ScheduledDistributionFilters = {}) {
  ...
  window.SuperTraining.ScheduledDistribution = {
    buildRows,
    filterRows,
    buildSummary,
    buildDistribution
